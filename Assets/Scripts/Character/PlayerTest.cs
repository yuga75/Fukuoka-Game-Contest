...
public class PlayerTest : MonoBehaviour
{
    ...
    ControllButton pauseButton;
    ControllButton fastButton;
    ControllButton resetButton;
    ...
    void Start()
    {
        ...
        PlayButton = GameObject.Find("ControllButton(empty)");
        playButton = PlayButton.GetComponent<ControllButton>();
        PauseButton = GameObject.Find("ControllButton(empty)");
        pauseButton = PauseButton.GetComponent<ControllButton>();
        FastButton = GameObject.Find("ControllButton(empty)");
        fastButton = FastButton.GetComponent<ControllButton>();
        ResetButton = GameObject.Find("ControllButton(empty)");
        resetButton = ResetButton.GetComponent<ControllButton>();
